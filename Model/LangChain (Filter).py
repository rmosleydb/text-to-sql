...
chain.invoke({"prompt":"who ordered the most items?", "schema_filter":["mfg_sales_demo.northwind"]})
...
model_name = f"robert_mosley.text_to_sql.dbrx_chain_filter"
...
serving_endpoint_name = "t2s_drbx_filter"
