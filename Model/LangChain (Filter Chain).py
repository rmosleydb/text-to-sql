...
# MAGIC %md
# MAGIC ## Filters
# MAGIC This is a RAG chain designed to receive a prompt and optional filters and outputs a sql result. The idea is to perform like **Genie Spaces**, where a list of tables are provided and the endpoint works within those constraints instead of searching throughout the whole lakehouse. This is ideal if there are multiple similar table structures where potential solutions could come from. 
# MAGIC
...
model_name = f"{catalog}.text_to_sql.dbrx_chain_filter"
...
serving_endpoint_name = "t2s_dbrx_filter"
